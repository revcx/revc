...
do
./evca_encoder -i foreman_cif8.yuv -w 176 -h 144 -z 30 -f 8 -q ${QP} -r ./tmp/test_cif_ld_i_q${QP}_etm.yuv -o ./tmp/test_cif_ld_i_q${QP}_etm.evc --config ./cfg/encoder_lowdelay_P_baseline.cfg -p 1
./evca_encoder -i foreman_cif8.yuv -w 176 -h 144 -z 30 -f 8 -q ${QP} -r ./tmp/test_cif_ld_p_q${QP}_etm.yuv -o ./tmp/test_cif_ld_p_q${QP}_etm.evc --config ./cfg/encoder_lowdelay_P_baseline.cfg
./evca_encoder -i foreman_cif8.yuv -w 176 -h 144 -z 30 -f 8 -q ${QP} -r ./tmp/test_cif_ld_b_q${QP}_etm.yuv -o ./tmp/test_cif_ld_b_q${QP}_etm.evc --config ./cfg/encoder_lowdelay_baseline.cfg
...
do
./evca_encoder -i foreman_cif8.yuv -w 176 -h 144 -z 30 -f 8 -q ${QP} -r ./tmp/test_cif_ra_b${BFRM}_q${QP}_etm.yuv -o ./tmp/test_cif_ra_b${BFRM}_q${QP}_etm.evc --config ./cfg/encoder_randomaccess_baseline_bn.cfg --max_b_frames ${BFRM}
...
for QP in 22 27 32 37
do
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 176 -h 144 -z 30 -f 8 -q ${QP} -r ./tmp/test_cif_ld_i_q${QP}_revc.yuv -o ./tmp/test_cif_ld_i_q${QP}_revc.evc --ref_pic_gap_length 8 --inter_slice_type 1 -v -p 1
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 176 -h 144 -z 30 -f 8 -q ${QP} -r ./tmp/test_cif_ld_p_q${QP}_revc.yuv -o ./tmp/test_cif_ld_p_q${QP}_revc.evc --ref_pic_gap_length 8 --inter_slice_type 1 -v
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 176 -h 144 -z 30 -f 8 -q ${QP} -r ./tmp/test_cif_ld_b_q${QP}_revc.yuv -o ./tmp/test_cif_ld_b_q${QP}_revc.evc --ref_pic_gap_length 8 --inter_slice_type 0 -v
...
for BFRM in 1 3 7 15
do
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 176 -h 144 -z 30 -f 8 -q ${QP} -r ./tmp/test_cif_ra_b${BFRM}_q${QP}_revc.yuv -o ./tmp/test_cif_ra_b${BFRM}_q${QP}_revc.evc --max_b_frames ${BFRM} --inter_slice_type 0 -v
