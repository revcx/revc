...
# ./ffmpeg.exe -i foreman_qcif.y4m -vframes 8 -f yuv4mpegpipe foreman_cif8.y4m
# ./ffmpeg.exe -i foreman_qcif.y4m -vframes 8 -vf scale=16x16 foreman_mb8.yuv

for QP in 22 27 32 37
do

./evca_encoder.exe -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ld_p_nodb_q${QP}_etm.yuv -o ./tmp/test_ld_p_nodb_q${QP}_etm.evc --config ./cfg/encoder_lowdelay_P_baseline_nodb.cfg
./evca_encoder.exe -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ld_b_nodb_q${QP}_etm.yuv -o ./tmp/test_ld_b_nodb_q${QP}_etm.evc --config ./cfg/encoder_lowdelay_baseline_nodb.cfg
./evca_encoder.exe -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ra_b_nodb_q${QP}_etm.yuv -o ./tmp/test_ra_b_nodb_q${QP}_etm.evc --config ./cfg/encoder_randomaccess_baseline_nodb.cfg
...
./evca_encoder.exe -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ld_p_q${QP}_etm.yuv -o ./tmp/test_ld_p_q${QP}_etm.evc --config ./cfg/encoder_lowdelay_P_baseline.cfg
./evca_encoder.exe -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ld_b_q${QP}_etm.yuv -o ./tmp/test_ld_b_q${QP}_etm.evc --config ./cfg/encoder_lowdelay_baseline.cfg
./evca_encoder.exe -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ra_b_q${QP}_etm.yuv -o ./tmp/test_ra_b_q${QP}_etm.evc --config ./cfg/encoder_randomaccess_baseline.cfg
...
do
./evca_encoder.exe -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ra_b${BFRM}_q${QP}_etm.yuv -o ./tmp/test_ra_b${BFRM}_q${QP}_etm.evc --config ./cfg/encoder_randomaccess_baseline_bn.cfg --max_b_frames ${BFRM}
...
for QP in 22 27 32 37
do
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ld_p_nodb_q${QP}_revc.yuv -o ./tmp/test_ld_p_nodb_q${QP}_revc.evc --ref_pic_gap_length 8 --disable_dbf --inter_slice_type 1 -v
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ld_b_nodb_q${QP}_revc.yuv -o ./tmp/test_ld_b_nodb_q${QP}_revc.evc --ref_pic_gap_length 8 --disable_dbf --inter_slice_type 0 -v
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ra_b_nodb_q${QP}_revc.yuv -o ./tmp/test_ra_b_nodb_q${QP}_revc.evc --max_b_frames      15 --disable_dbf --inter_slice_type 0 -v
...
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ld_p_q${QP}_revc.yuv -o ./tmp/test_ld_p_q${QP}_revc.evc --ref_pic_gap_length 8 --inter_slice_type 1 -v
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ld_b_q${QP}_revc.yuv -o ./tmp/test_ld_b_q${QP}_revc.evc --ref_pic_gap_length 8 --inter_slice_type 0 -v
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ra_b_q${QP}_revc.yuv -o ./tmp/test_ra_b_q${QP}_revc.evc --max_b_frames      15 --inter_slice_type 0 -v
...
for BFRM in 1 3 7 15
do
cargo run --bin revce --release -- -i foreman_cif8.yuv -w 352 -h 288 -z 30 -f 8 -q ${QP} -r ./tmp/test_ra_b${BFRM}_q${QP}_revc.yuv -o ./tmp/test_ra_b${BFRM}_q${QP}_revc.evc --max_b_frames ${BFRM} --inter_slice_type 0 -v
