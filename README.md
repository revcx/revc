...
Compared to H.264/AVC High Profile (JM19.0), MPEG-5 EVC (ETM baseline) provides about 30% BD-rate reduction with reduced encoding computation complexity and comparable decoding computation complexity.
